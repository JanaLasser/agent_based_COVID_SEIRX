#!/bin/bash
#
#SBATCH -J COVID_SEIRX_data_creation_lower_secondary_dc_medium
#SBATCH -N 1                 
#SBATCH -o output_lower_secondary_dc_medium
#SBATCH -e error_lower_secondary_dc_medium
...
for school_layout_start_index in $(seq 2 8)
	do
