#!/bin/bash
#
#SBATCH -J COVID_SEIRX_data_creation_lower_secondary_dc_2
#SBATCH -N 1                 
#SBATCH -o output_lower_secondary_dc_2
#SBATCH -e error_lower_secondary_dc_2
...
for school_layout_start_index in $(seq 2 4)
	do
