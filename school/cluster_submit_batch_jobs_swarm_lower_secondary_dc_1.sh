#!/bin/bash
#
#SBATCH -J COVID_SEIRX_data_creation_lower_secondary_dc_1
#SBATCH -N 1                 
#SBATCH -o output_lower_secondary_dc_1
#SBATCH -e error_lower_secondary_dc_1
