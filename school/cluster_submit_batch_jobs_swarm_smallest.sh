#!/bin/bash
#
#SBATCH -J COVID_SEIRX_data_creation_lower_secondary_dc_smallest
#SBATCH -N 1                 
#SBATCH -o output_lower_secondary_dc_smallest
#SBATCH -e error_lower_secondary_dc_smallest
...
for school_layout_start_index in $(seq 9 24)
	do
