#!/bin/bash
#
#SBATCH -J COVID_SEIRX_data_creation_lower_secondary_dc_3
#SBATCH -N 1                 
#SBATCH -o output_lower_secondary_dc_3
#SBATCH -e error_lower_secondary_dc_3
...
for school_layout_start_index in $(seq 5 9)
	do
