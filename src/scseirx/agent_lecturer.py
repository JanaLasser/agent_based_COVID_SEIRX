...
class lecturer(agent_SEIRX):
    '''
    A lecturer with an infection status
    '''
    ...
    def step(self):
        '''
        Infection step: if a lecturer is infected and not in quarantine, it 
        interacts with other students and lecturers trough the specified 
        ...
        if self.infectious:
            if not self.quarantined:
                ...
                # interaction network
                lecturer = self.get_contacts('lecturer')
